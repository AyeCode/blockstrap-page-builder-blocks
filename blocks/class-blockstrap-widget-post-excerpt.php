...
class BlockStrap_Widget_Post_Excerpt extends WP_Super_Duper {
	...
	public function __construct() {
		...
		$options = array(
			...
			'name'               => __( 'BS > Post Excerpt', 'blockstrap' ),
			'widget_ops'         => array(
				'classname'   => 'bs-post-excerpt',
				'description' => esc_html__( 'Displays the post excerpt in a more customizable way that default.', 'blockstrap' ),
			),
			'example'            => array(
				'attributes' => array(
					'after_text' => 'Earth',
			...
			'block_group_tabs'   => array(
				'content'  => array(
					'groups' => array( __( 'Excerpt', 'blockstrap' ) ),
					'tab'    => array(
	...
	public function set_arguments() {
		...
		$arguments['html_tag'] = array(
			...
			'default'  => 'h1',
			'desc_tip' => true,
			'group'    => __( 'Excerpt', 'blockstrap' ),
		);

		$arguments['trim_type'] = array(
			'type'     => 'select',
			'title'    => __( 'Trim type', 'blockstrap' ),
			'options'  => array(
				'words'      => 'words',
		...
		$arguments['trim_count'] = array(
			'type'        => 'number',
			'title'       => __( 'Trim count', 'blockstrap' ),
			'placeholder' => '55',
			'default'     => '',
			'desc_tip'    => false,
			'group'       => __( 'Excerpt', 'blockstrap' ),
		...
		$arguments['trim_append'] = array(
			'type'        => 'text',
			'title'       => __( 'Trim append', 'blockstrap' ),
			'placeholder' => '…',
			'default'     => '',
			'desc_tip'    => false,
			'group'       => __( 'Excerpt', 'blockstrap' ),
